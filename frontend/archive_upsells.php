...
class VI_WOO_BOOSTSALES_Frontend_Archive_Upsells {
	...
	public function product_html() {
		VI_WOO_BOOSTSALES_Frontend_Upsells::$added_to_cart = isset( $_POST['added_to_cart'] ) ? wc_clean( $_POST['added_to_cart'] ) : array();// phpcs:ignore WordPress.Security.NonceVerification.Missing
