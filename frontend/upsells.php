...
class VI_WOO_BOOSTSALES_Frontend_Upsells {
	...
	public function woocommerce_template_loop_product_title( $product ) {
		echo '<span class="woocommerce-loop-product__title">' . VI_WOO_BOOSTSALES_Data::wp_kses_post( $product->get_title() ) . '</span>';// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
	...
	public function woocommerce_template_loop_product_thumbnail( $product ) {
		echo VI_WOO_BOOSTSALES_Upsells::get_product_image( $product );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
		...
		if ( count( $category_ids ) ) {
			...
			switch ( $sort_product ) {
				...
				case 2;
					...
					$u_args['meta_key'] = '_price';// phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_key
					$u_args['order']    = 'desc';
					break;
				case 3;
					$u_args['orderby']  = 'meta_value_num';
				...
				case 5;
					$u_args['orderby']  = 'meta_value_num';
					$u_args['meta_key'] = 'total_sales';// phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_key
					$u_args['order']    = 'desc';
					break;
				default;
					$u_args['orderby'] = 'title';
