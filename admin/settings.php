...
class VI_WOO_BOOSTSALES_Admin_Settings {
	...
	public function crosssell_notice( $settings ) {
		?>
        <div class="vi-ui message positive tiny">
            <div class="header"><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( __( 'To use this feature, please go to <a target="_blank" href="admin.php?page=woo-boost-sales-crosssell">Cross-Sells</a> page to create bundles', 'woo-boost-sales' ) );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
        </div>
		<?php
	}
	...
	public function upsell_notice( $settings ) {
        ...
        <div class="vi-ui message positive tiny">
            ...
            <ol>
                <li><?php /* translators: %s: admin url */
                    printf( VI_WOO_BOOSTSALES_Data::wp_kses_post( __( '<strong>Products/categories</strong> you select on <a target="_blank" href="%s">Up-sells page</a>', 'woo-boost-sales' ) ), esc_url( admin_url( 'admin.php?page=woo-boost-sales-upsell' ) ) );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></li>
                <li><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( __( '<strong>Recently Viewed Products</strong> if enabled', 'woo-boost-sales' ) );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></li>
                <li><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( __( '<strong>Products in category</strong> if enabled', 'woo-boost-sales' ) );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></li>
                <li><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( __( '<strong>Upsell by tags</strong> if enabled', 'woo-boost-sales' ) );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></li>
            </ol>
        </div>
		<?php
	}
	...
	public function init_scripts() {
		...
		if ( $page === 'woo-boost-sales' ) {
			wp_enqueue_script( 'woo-boost-sales-admin', VI_WOO_BOOSTSALES_JS . 'woo-boost-sales-admin.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
