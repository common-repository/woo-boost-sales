...
<div class="wbs-wcpb-bundled-item wc-metabox <?php echo esc_attr( isset( $open_closed ) ? $open_closed : '' ) ?>"
    ...
    <h3>
        ...
        <strong class="item-title"><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( $title . ' (#' . $product_id . ')' . $parent );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong>
    </h3>
