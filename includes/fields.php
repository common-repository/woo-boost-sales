		...
		public function admin_enqueue_scripts() {
			...
			if ( count( $this->page ) ) {
				if ( isset( $_GET['page'] ) ) {// phpcs:ignore WordPress.Security.NonceVerification.Recommended
					if ( ! in_array( sanitize_text_field( $_GET['page'] ), $this->page ) ) {// phpcs:ignore WordPress.Security.NonceVerification.Recommended
						return;
					}
			...
			/*Stylesheet*/
			wp_enqueue_style( 'villatheme-field-image', VI_WOO_BOOSTSALES_CSS . 'image.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-transition', VI_WOO_BOOSTSALES_CSS . 'transition.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-form', VI_WOO_BOOSTSALES_CSS . 'form.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-input', VI_WOO_BOOSTSALES_CSS . 'input.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-icon', VI_WOO_BOOSTSALES_CSS . 'icon.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-dropdown', VI_WOO_BOOSTSALES_CSS . 'dropdown.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-checkbox', VI_WOO_BOOSTSALES_CSS . 'checkbox.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-segment', VI_WOO_BOOSTSALES_CSS . 'segment.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-menu', VI_WOO_BOOSTSALES_CSS . 'menu.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-tab', VI_WOO_BOOSTSALES_CSS . 'tab.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-message', VI_WOO_BOOSTSALES_CSS . 'message.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-field-button', VI_WOO_BOOSTSALES_CSS . 'button.min.css', [], VI_WOO_BOOSTSALES_VERSION );
			wp_enqueue_style( 'villatheme-fields', VI_WOO_BOOSTSALES_CSS . 'fields.css', [], VI_WOO_BOOSTSALES_VERSION );

			/*Script*/
			wp_enqueue_script( 'villatheme-field-transition', VI_WOO_BOOSTSALES_JS . 'transition.min.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			wp_enqueue_script( 'villatheme-field-dropdown', VI_WOO_BOOSTSALES_JS . 'dropdown.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			wp_enqueue_script( 'villatheme-field-checkbox', VI_WOO_BOOSTSALES_JS . 'checkbox.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			wp_enqueue_script( 'villatheme-field-tab', VI_WOO_BOOSTSALES_JS . 'tab.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			wp_enqueue_script( 'villatheme-field-address', VI_WOO_BOOSTSALES_JS . 'jquery.address-1.6.min.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			wp_enqueue_media();
			wp_enqueue_script( 'villatheme-fields', VI_WOO_BOOSTSALES_JS . 'fields.js', array( 'jquery' ), VI_WOO_BOOSTSALES_VERSION, false );
			/*Color picker*/
			wp_enqueue_script(
			...
			wp_enqueue_style( 'select2', VI_WOO_BOOSTSALES_CSS . 'select2.min.css', [], VI_WOO_BOOSTSALES_VERSION );
                    ...
                    <div class="vi-ui attached tabular menu">
						<?php foreach ( $args as $k => $arg ) { ?>
                            <div class="item <?php echo ( isset( $arg['active'] ) && $arg['active'] ) ? 'active' : '' ?>"
								...
								<?php echo isset( $arg['title'] ) ? VI_WOO_BOOSTSALES_Data::wp_kses_post( $arg['title'] ) : '';// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                            </div>
						<?php } ?>
                    </div>
					<?php
									...
									foreach ( $arg['fields'] as $field ) {
										...
										if ( ! $name && ! $do_action ) {
                                            ...
                                            <tr class="<?php echo esc_attr( $class ); ?>">
                                                <th scope="row">
                                                    <label>
														<?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( $label );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                                                    </label>
                                                </th>
                                                <td>
													<?php
													...
													if ( $description ) { ?>
                                                        <p class="description"><?php echo VI_WOO_BOOSTSALES_Data::wp_kses_post( $description );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
														<?php
													}
													?>
                                                </td>
