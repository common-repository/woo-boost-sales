    ...
    $('.button-save').on('click', function () {
        ...
        if (product_id) {
            ...
            if (c_id == null && !other_bundle_id) {
                ...
                $.ajax({
                    type: 'POST',
                    data: 'action=wbs_c_save_product' + '&id=' + product_id + '&c_id=' + c_id + '&product_bundle_id=' + product_bundle_id + '&other_bundle_id=' + other_bundle_id + '&nonce=' + wbs_crosssell_admin_params.nonce,
